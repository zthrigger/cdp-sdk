...
public enum X402VerifyInvalidReason {
  ...
  X402VerifyInvalidReason(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static X402VerifyInvalidReason fromValue(String value) {
    for (X402VerifyInvalidReason b : X402VerifyInvalidReason.values()) {
