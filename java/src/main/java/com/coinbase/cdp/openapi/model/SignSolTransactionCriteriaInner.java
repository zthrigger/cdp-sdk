...
@JsonDeserialize(using = SignSolTransactionCriteriaInner.SignSolTransactionCriteriaInnerDeserializer.class)
@JsonSerialize(using = SignSolTransactionCriteriaInner.SignSolTransactionCriteriaInnerSerializer.class)
public class SignSolTransactionCriteriaInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SignSolTransactionCriteriaInner.class.getName());

    public static class SignSolTransactionCriteriaInnerSerializer extends StdSerializer<SignSolTransactionCriteriaInner> {
        public SignSolTransactionCriteriaInnerSerializer(Class<SignSolTransactionCriteriaInner> t) {
            super(t);
        }

        public SignSolTransactionCriteriaInnerSerializer() {
            this(null);
        }

        @Override
        public void serialize(SignSolTransactionCriteriaInner value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SignSolTransactionCriteriaInnerDeserializer extends StdDeserializer<SignSolTransactionCriteriaInner> {
        public SignSolTransactionCriteriaInnerDeserializer() {
            this(SignSolTransactionCriteriaInner.class);
        }

        public SignSolTransactionCriteriaInnerDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SignSolTransactionCriteriaInner deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SignSolTransactionCriteriaInner ret = new SignSolTransactionCriteriaInner();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for SignSolTransactionCriteriaInner: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SignSolTransactionCriteriaInner getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SignSolTransactionCriteriaInner cannot be null");
        }
    }
    ...
    public SignSolTransactionCriteriaInner() {
        super("oneOf", Boolean.FALSE);
    }

    public SignSolTransactionCriteriaInner(MintAddressCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(ProgramIdCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(SolAddressCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(SolDataCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(SolValueCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(SplAddressCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SignSolTransactionCriteriaInner(SplValueCriterion o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SignSolTransactionCriteriaInner.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SignSolTransactionCriteriaInner.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * MintAddressCriterion, ProgramIdCriterion, SolAddressCriterion, SolDataCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be MintAddressCriterion, ProgramIdCriterion, SolAddressCriterion, SolDataCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion");
    }
     ...
     * MintAddressCriterion, ProgramIdCriterion, SolAddressCriterion, SolDataCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion
     *
     * @return The actual instance (MintAddressCriterion, ProgramIdCriterion, SolAddressCriterion, SolDataCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion)
     */
    @Override
