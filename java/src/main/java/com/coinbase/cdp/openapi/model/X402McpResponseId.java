...
@JsonDeserialize(using = X402McpResponseId.X402McpResponseIdDeserializer.class)
@JsonSerialize(using = X402McpResponseId.X402McpResponseIdSerializer.class)
public class X402McpResponseId extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(X402McpResponseId.class.getName());

    public static class X402McpResponseIdSerializer extends StdSerializer<X402McpResponseId> {
        public X402McpResponseIdSerializer(Class<X402McpResponseId> t) {
            super(t);
        }

        public X402McpResponseIdSerializer() {
            this(null);
        }

        @Override
        public void serialize(X402McpResponseId value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class X402McpResponseIdDeserializer extends StdDeserializer<X402McpResponseId> {
        public X402McpResponseIdDeserializer() {
            this(X402McpResponseId.class);
        }

        public X402McpResponseIdDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public X402McpResponseId deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                X402McpResponseId ret = new X402McpResponseId();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for X402McpResponseId: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public X402McpResponseId getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "X402McpResponseId cannot be null");
        }
    }
    ...
    public X402McpResponseId() {
        super("oneOf", Boolean.FALSE);
    }

    public X402McpResponseId(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public X402McpResponseId(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(X402McpResponseId.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return X402McpResponseId.schemas;
    }
