...
class TestCreateEndUserRequest(unittest.TestCase):
    """CreateEndUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateEndUserRequest:
        """Test CreateEndUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateEndUserRequest`
        """
    ...
    def testCreateEndUserRequest(self):
        """Test CreateEndUserRequest"""
